...
var ReactSVG = function (_Component) {
  ...
  _createClass(ReactSVG, [{
    ...
    value: function renderSVG() {
      ...
      div.innerHTML = _server2.default.renderToStaticMarkup(_react2.default.createElement('div', { 'data-src': path }));

      var wrapper = this.container.insertBefore(div.firstChild, this.container.firstChild);
    ...
    value: function render() {
      ...
      var restProps = (0, _lodash.omit)(this.props, Object.keys(ReactSVG.propTypes));
      return _react2.default.createElement(Component, _extends({ ref: this.refCallback,
